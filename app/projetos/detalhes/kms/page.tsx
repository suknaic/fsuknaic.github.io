    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="space-y-12">
          ...
          <div className="flex-row sm:flex-col space-y-6">
            <div className="space-y-6 bg-muted/50 p-8 rounded-xl border">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground">
                Enterprise-grade knowledge management platform with JWT
        ...
        <section className="space-y-6 bg-muted/50 p-8 rounded-xl border">
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            Developed for H&K Corporation, this enterprise system enables
            efficient management of users, projects, tasks, and announcements
            through a secure, role-based interface built with modern web
            technologies.
          </p>
