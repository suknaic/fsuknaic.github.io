    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="space-y-12">
          ...
          <div className="flex-row sm:flex-col space-y-6">
            <div className="space-y-6 bg-muted/50 p-8 rounded-xl border">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground">
                28-screen PICTIVE prototype covering admin web interface and
                mobile voter experience.
              </p>
        ...
        <section className="space-y-6 bg-muted/50 p-8 rounded-xl border">
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            The H&L E-Voting System is a secure, accessible, and user-friendly
            platform designed for Hargreaves Lansdown shareholders to
            participate in corporate elections. The project features dual
            interfaces: a web-based admin panel for election management and a
            mobile app for shareholders to vote securely. The design emphasizes
            accessibility, security, and ease of use, ensuring compliance with
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 bg-blue-50 rounded-xl border border-blue-200">
              ...
              <blockquote className="text-blue-700 italic">
                &quot; The e-voting system is incredibly intuitive and
                accessible. The team did an excellent job balancing security
                with ease of use.&quot;
                <br />
                <span className="font-semibold">
                  — Hargreaves Lansdown Stakeholder
                </span>
              </blockquote>
            </div>
          </div>
